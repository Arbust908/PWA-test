<template>
    ...
    <header class="flex flex-col md:flex-row md:justify-between items-center md:mb-4">
        <h1 class="font-bold text-gray-900 text-xl self-start mb-3 md:mb-0">Arena - {{ id }}</h1>
    </header>
        ...
        <fieldset>
          <div class="input-block">
            ...
            <div class="input-block">
                ...
                <div class="mt-1">
                    <input v-model="description" name="description" type="text" placeholder= "Una descripcion"/>
                </div>
            </div>
            <div class="input-block">
