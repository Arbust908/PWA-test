        ...
        <header class="flex flex-col md:flex-row md:justify-between items-center md:mb-4">
          ...
          <section class="bg-white rounded-md shadow-sm">
            <!--<form method="POST" action="/" class="p-4 max-w-lg">
                <InputPack
                v-model:newRepresentative="name"
                title="Name"
                naming='name'
                type='text'
                ...
                <InputPack
                v-model="representativeData"
                title="Datos del Representante"
                naming='datos-representante'
                type='text'
                placeholder='Datos del representante...'
                />
                <InputPack
                v-model="representativeContact"
                title="Contacto del repseentante"
                naming='representante-contacto'
                type='text'
                placeholder='Contacto de representante...'
                />
                <InputPack
                v-model="observations"
                title="Observaciones"
                naming='observaciones'
                type='text'
