      ...
      <form method="POST" action="/" class="p-4 flex flex-col gap-4">
        <fieldset class="py-2 w-full max-w-xl grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
          <label class="col-span-1" for="client">
            <span>Cliente</span>
            <select id="client" v-model="currentSandPlan.companyId" class="input" name="client">
          ...
          <label class="col-span-1" for="pit">
            <span>Pozo</span>
            <select id="pit" v-model="currentSandPlan.pitId" class="input" name="pit">
...
import { BookmarkIcon, DotsVerticalIcon, ChevronUpIcon } from '@heroicons/vue/outline';
...
export default {
  ...
  setup() {
    ...
    const duplicateStage = (stage) => {
      ...
      // const lastStageId = { id: lastStage.id };
      // const lastStageStage = { stage: lastStage.stage };
