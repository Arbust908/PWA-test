      ...
      <form method="POST" action="/" class="p-4 w-full flex flex-col lg:flex-row">
        <fieldset class="flex flex-col w-full">
          <div class="input-block p-4">
            ...
            <div class="mt-1">
              <input v-model="newSandProvider.name" class="w-full rounded-md shadow" name="name" type="text" placeholder="Nombre de cliente" />
            </div>
          </div>
          <div class="input-block p-4">
            <label for="legalName" class=""> Razón Social </label>
            <div class="mt-1">
              <input v-model="newSandProvider.legalName" class="w-full rounded-md shadow" name="legalName" type="text" placeholder="Razón social del cliente" />
            </div>
          </div>
          <div class="input-block p-4">
            <label for="legalId" class=""> CUIT </label>
            <div class="mt-1">
              <input v-model="newSandProvider.legalId" class="w-full rounded-md shadow" name="legalId" type="text" placeholder="CUIT de cliente" />
            </div>
          </div>
          <div class="input-block p-4">
            <label for="meshType" class=""> Tipo de malla </label>
            <div class="mt-1">
              <input v-model="newSandProvider.meshType" class="w-full rounded-md shadow" name="meshType" type="text" placeholder="Tipo de malla" />
            </div>
          </div>
        </fieldset>
        <fieldset class="flex flex-col  w-full">
          <div class="input-block p-4">
            ...
            <div class="mt-1">
              <input v-model="newSandProvider.grains" class="w-full rounded-md shadow" name="grains" type="text" placeholder="Granulado" />
            </div>
          </div>
          <div class="input-block p-4">
          ...
          <div class="input-block p-4">
            ...
            <div class="mt-1">
              <textarea v-model="newSandProvider.observations" class="w-full rounded-md shadow px-3 py-2 focus:outline-none" rows="5" name="observations" type="text" placeholder="Observaciones"></textarea>
            </div>
          </div>
        </fieldset>
      </form>
...
<script lang="ts">
import { ref, Ref, computed, toRefs, reactive, onMounted } from 'vue';
...
export default {
  ...
  setup() {
    ...
    const companyRepresentatives = ref([])    
