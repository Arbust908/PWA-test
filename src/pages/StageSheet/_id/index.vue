<template>
    <Layout class="relative">
        ...
        <!-- *** -->
        <footer class="mt-8 space-x-8 flex justify-end">
...
<script lang="ts">
    ...
    export default {
        ...
        setup() {
            ...
            useTitle(`Stage Sheet ${id} <> Sandflow`);
            ...
            const isFull = computed(() => {
                ...
                const noZeroSandTypeZero =
                    (currentStageSheet.value.stages && currentStageSheet.value.stages[0].quantity1 !== 0) ||
                    currentStageSheet.value.stages[0].quantity2 !== 0 ||
                    currentStageSheet.value.stages[0].quantity3 !== 0;

                return !!(currentStageSheet.value && noZeroSandTypeNull && noZeroSandTypeZero);
            });
            const save = (): void => {
