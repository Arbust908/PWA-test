<template>
  <Modal type="off" :open="showModal" @close="$emit('close')">
      <template #body>
        ...
        <div class="w-full max-w-sm text-left text-gray-800">
            <div class="bg-gray-100 mt-3 rounded-r-md pt-3 pl-4 pb-4 border-l-4 border-green-500 border-t-0">
                ...
                <ul>
                  <li v-for="(so, index) in po.sandOrders"
                  :key="index"
            ...
            <div class="bg-gray-100 mt-3 rounded-r-md pt-3 pl-4 pb-4 border-l-4 border-green-500 border-t-0">
                ...
                <li v-for="(tp, i) in po.transportOrders" :key="i" 
                  class="ml-2 text-black text-sm list-none mt-2">
      ...
      <template #btn>
          <input type="checkbox" id="checkbox" v-model="checked" class="outline-none appearance-none focus:outline-none" />
